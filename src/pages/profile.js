...
class Profile extends Component {
  state = {
    ...
    phone: "",
    bio: "",
    profilePic: "https://www.flynz.co.nz/wp-content/uploads/profile-placeholder.png",
    items: [],
    wishlist: [],
    searchTerm: "",
    pg: "Profile",
  ...
  loadUser = id => {
    API.getUserInfo(id).then(
      res => {
        let pic = res.data.profilePic ? res.data.profilePic : "https://www.flynz.co.nz/wp-content/uploads/profile-placeholder.png";
        this.setState({
          isLoaded: true,
          error: null,
          _id: res.data._id,
